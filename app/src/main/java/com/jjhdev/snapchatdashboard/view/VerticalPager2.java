 ...
 */
public class VerticalPager2 extends ViewGroup {
	 ...
	 */
	public VerticalPager2(Context context, AttributeSet attrs) {
	 ...
	 *            Unused.
	 */
	public VerticalPager2(Context context, AttributeSet attrs, int defStyle) {
